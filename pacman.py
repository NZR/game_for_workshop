...
import pac_colors  # colors, by name, usable within the game.


game_logo = pygame.image.load('images/Trollman.png')
...
def setupRoomOne(all_sprites_list):
    ...
    for item in walls:
        wall = Wall(item[0], item[1], item[2], item[3], pac_colors.blue)
        wall_list.add(wall)
...
def setupGate(all_sprites_list):
    ...
    gate.add(Wall(282, 242, 42, 2, pac_colors.white))
...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color, width, height):
        ...
        self.image = pygame.Surface([width, height])
        self.image.fill(pac_colors.white)
        self.image.set_colorkey(pac_colors.white)
...
background.fill(pac_colors.black)
...
def startGame():
    ...
    print(help(pygame.sprite.RenderPlain()))
    ...
    for row in range(19):
        for column in range(19):
            if (row == 7 or row == 8) and (column == 8 or column == 9 or column == 10):
                ...
                block = Block(pac_colors.yellow, 4, 4)
...
def doNext(message, left, all_sprites_list, block_list, monsta_list, pacman_collide, wall_list, gate):
    while True:
        ...
        #Won or lost
        text1 = font.render(message, True, pac_colors.white)
        screen.blit(text1, [left, 233])

        text2 = font.render("To play again, press ENTER.",
                            True, pac_colors.white)
        screen.blit(text2, [135, 303])
        text3 = font.render("To quit, press ESCAPE.", True, pac_colors.white)
